...
#include "condensation_ptr.hf"
      ...
      case('MP_P3')
        ...
        ! note: qitend, this is done below since it is p3_ncat-dependent
         ...
         !#  Predicted Particle Properties (P3) microphysics (v5)
         if (p3_ncat == 1) then
              ...
              if (p3_trplmomi) then
               ...
               if (p3_predictfiliq) then
                   istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,      &
                        ...
                        qi_type,p3_depfact,p3_subfact,p3_debug,a_h_cb,a_h_sn,a_vis,a_vis1,      &
                        a_vis2,a_vis3,a_slw,p3_scpf_on,p3_pfrac,p3_resfact,a_fxp,               &
                        qti1p,qmi1p,nti1p,bmi1p,a_effradi1,qiliq_1=qli1p)
               else
                   istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,      &
                        sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                        a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
            ...
            if (p3_trplmomi) then
             if (p3_predictfiliq) then
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 ...
                 diag_effi_2=a_effradi2,zitot_2=zti2p,qiliq_2=qli2p)
             else
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                 a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
                 ...
                 qti1p,qmi1p,nti1p,bmi1p,a_effradi1,zitot_1=zti1p,                       &
                 qitot_2=qti2p,qirim_2=qmi2p,nitot_2=nti2p,birim_2=bmi2p,                &
                 diag_effi_2=a_effradi2,zitot_2=zti2p)
             endif
            else
             if (p3_predictfiliq) then
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 ...
                 qti1p,qmi1p,nti1p,bmi1p,a_effradi1,qiliq_1=qli1p,                       &
                 qitot_2=qti2p,qirim_2=qmi2p,nitot_2=nti2p,birim_2=bmi2p,                &
                 diag_effi_2=a_effradi2,qiliq_2=qli2p)
             else
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                 a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
            ...
            if (p3_trplmomi) then
             if (p3_predictfiliq) then
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 ...
                 diag_effi_3=a_effradi3,zitot_3=zti3p,qiliq_3=qli3p)
             else
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                 a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
                 ...
                 diag_effi_2=a_effradi2,zitot_2=zti2p,                                   &
                 qitot_3=qti3p,qirim_3=qmi3p,nitot_3=nti3p,birim_3=bmi3p,                &
                 diag_effi_3=a_effradi3,zitot_3=zti3p)
             endif
            else
             if (p3_predictfiliq) then
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 ...
                 diag_effi_2=a_effradi2,qiliq_2=qli2p,                                   &
                 qitot_3=qti3p,qirim_3=qmi3p,nitot_3=nti3p,birim_3=bmi3p,                &
                 diag_effi_3=a_effradi3,qiliq_3=qli3p)
             else
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                 a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
            ...
            if (p3_trplmomi) then
             if (p3_predictFiliq) then
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 ...
                 diag_effi_4=a_effradi4,zitot_4=zti4p,qiliq_4=qli4p)
             else
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                 a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
                 ...
                 diag_effi_3=a_effradi3,zitot_3=zti3p,                                   &
                 qitot_4=qti4p,qirim_4=qmi4p,nitot_4=nti4p,birim_4=bmi4p,                &
                 diag_effi_4=a_effradi4,zitot_4=zti4p)
             endif
            else
            if (p3_predictFiliq) then
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 ...
                 diag_effi_3=a_effradi3,qiliq_3=qli3p,                                   &
                 qitot_4=qti4p,qirim_4=qmi4p,nitot_4=nti4p,birim_4=bmi4p,                &
                 diag_effi_4=a_effradi4, qiliq_4=qli4p)
             else
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,    &
                 sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                 a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
