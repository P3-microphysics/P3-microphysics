...
!==================================================================================================!
#ifndef ECCCGEM
! NOTE: WRF_wrapper is not ready yet to be used with p3_predictfiliq = .true.
...
!==================================================================================================!
 ...
 function mp_p3_wrapper_gem(  qvap_m,qvap,temp_m,temp,dt,dt_max,ww,psfc,gztherm,gzmom,sigma,kount,&
...
SUBROUTINE access_lookup_table_coll_3mom(dumzz,dumjj,dumii,dumj,dumi,index,dum1,dum3,          &
 ...
 real    :: dum1,dum3,dum4,dum5,dum6,dum7,proc,dproc1,dproc2,iproc1,iproc2,  &
