...
#include "condensation_ptr.hf"
      ...
      case('MP_P3')
        ...
        ! note: qitend, this is done below since it is p3_ncat-dependent
         ...
         !#  Predicted Particle Properties (P3) microphysics (v4.0.0)
         if (p3_ncat == 1) then
            ...
            if (p3_trplmomi) then
              istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,       &
                    ...
                    qti1p,qmi1p,nti1p,bmi1p,a_effradi1, zitot_1=zti1p)
            else
               istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,      &
                    sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                    a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
         ...
         elseif (p3_ncat == 2) then
            ...
            if (p3_trplmomi) then
               istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,      &
                    ...
                    a_vis2,a_vis3,a_slw,p3_scpf_on,p3_pfrac,p3_resfact,a_fxp,               &
                    qti1p,qmi1p,nti1p,bmi1p,a_effradi1, zitot_1=zti1p,                      &
                    qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p, diag_effi_2=a_effradi2, zitot_2=zti2p)
!                     qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p, zitot_2=zti2p)
            else
               istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,      &
                    sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                    a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
                    ...
                    a_vis2,a_vis3,a_slw,p3_scpf_on,p3_pfrac,p3_resfact,a_fxp,               &
                    qti1p,qmi1p,nti1p,bmi1p,a_effradi1,                                     &
                   qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p, diag_effi_2=a_effradi2)
!                    qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p)
            endif
            if (istat1 >= 0) then
         ...
         elseif (p3_ncat == 3) then
            ...
            if (p3_trplmomi) then
               istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,      &
                    ...
                    qti1p,qmi1p,nti1p,bmi1p,a_effradi1, zitot_1=zti1p,                      &
                    qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p, diag_effi_2=a_effradi2, zitot_2=zti2p,  &
                    qitot_3=qti3p, qirim_3=qmi3p, nitot_3=nti3p, birim_3=bmi3p, diag_effi_3=a_effradi3, zitot_3=zti3p)
!                     qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p, zitot_2=zti2p,  &
!                     qitot_3=qti3p, qirim_3=qmi3p, nitot_3=nti3p, birim_3=bmi3p, zitot_3=zti3p)
            else
               istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,      &
                    sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                    a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
                    ...
                    qti1p,qmi1p,nti1p,bmi1p,a_effradi1,                                     &
                    qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p, diag_effi_2=a_effradi2,  &
                    qitot_3=qti3p, qirim_3=qmi3p, nitot_3=nti3p, birim_3=bmi3p, diag_effi_3=a_effradi3)
!                     qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p,     &
!                     qitot_3=qti3p, qirim_3=qmi3p, nitot_3=nti3p, birim_3=bmi3p)
            endif
            if (istat1 >= 0) then
         ...
         elseif (p3_ncat == 4) then
            ...
            if (p3_trplmomi) then
               istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,      &
                    ...
                    qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p, diag_effi_2=a_effradi2, zitot_2=zti2p,  &
                    qitot_3=qti3p, qirim_3=qmi3p, nitot_3=nti3p, birim_3=bmi3p, diag_effi_3=a_effradi3, zitot_3=zti3p,  &
                    qitot_4=qti4p, qirim_4=qmi4p, nitot_4=nti4p, birim_4=bmi4p, diag_effi_4=a_effradi4, zitot_4=zti4p)
!                     qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p, zitot_2=zti2p,  &
!                     qitot_3=qti3p, qirim_3=qmi3p, nitot_3=nti3p, birim_3=bmi3p, zitot_3=zti3p,  &
!                     qitot_4=qti4p, qirim_4=qmi4p, nitot_4=nti4p, birim_4=bmi4p, zitot_4=zti4p)
            else
               istat1 = mp_p3_wrapper_gem(qqm,qqp,ttm,ttp,dt,p3_dtmax,ww,psp,zgztherm,      &
                    sigma,kount,trnch,ni,nkm1,a_tls,a_tss,a_tls_rn1,a_tls_rn2,a_tss_sn1,    &
                    a_tss_sn2,a_tss_sn3,a_tss_pe1,a_tss_pe2,a_tss_snd,a_zet,a_zec,          &
                    ...
                    qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p, diag_effi_2=a_effradi2,  &
                    qitot_3=qti3p, qirim_3=qmi3p, nitot_3=nti3p, birim_3=bmi3p, diag_effi_3=a_effradi3,  &
                    qitot_4=qti4p, qirim_4=qmi4p, nitot_4=nti4p, birim_4=bmi4p, diag_effi_4=a_effradi4)
!                     qitot_2=qti2p, qirim_2=qmi2p, nitot_2=nti2p, birim_2=bmi2p,   &
!                     qitot_3=qti3p, qirim_3=qmi3p, nitot_3=nti3p, birim_3=bmi3p,   &
!                     qitot_4=qti4p, qirim_4=qmi4p, nitot_4=nti4p, birim_4=bmi4p)
            endif
            if (istat1 >= 0) then
