...
module phy_options
   ...
   !# Parameters to calculate the Equation of Time (EOT) for the solar angle (KW)
   ! EOT_ecc       : eccentricity 
   ! EOT_obl_deg   : obliquity [degree]
   ! EOT_perhi_180 : perihelion minus 180 deg [degree]
   real              :: EOT_ecc       = 0.016724
   real              :: EOT_obl_deg   = -1.  ! Used as flag! Current value is 23.45 deg
   real              :: EOT_perhi_180 = 100.33  
   namelist /physics_cfgs/   EOT_ecc, EOT_obl_deg, EOT_perhi_180
   namelist /physics_cfgs_p/ EOT_ecc, EOT_obl_deg, EOT_perhi_180
